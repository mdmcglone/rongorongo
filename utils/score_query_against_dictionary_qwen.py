...
DEFAULT_QWEN_UTIL = Path("/Users/emdmcglone/Desktop/mareep/qwen25_vl/util.py")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--local-dir", type=Path, help="Optional local model directory passed to qwen25_vl.util.simple_call.")
